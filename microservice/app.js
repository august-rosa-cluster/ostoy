...
app.get('/', function(request, response) {
  //let randomColor = getRandomColor(); // <-- comment this -- adding more text
...
app.get('/hpa', function(request, response){
  ...
  let result = 0;
  let baseNumber = 1; //change this to make it slower or faster by increasing/decreasing this number  
